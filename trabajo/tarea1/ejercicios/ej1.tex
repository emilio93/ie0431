\begin{ejercicio}
  ...
  \begin{enumerate}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.85\textwidth]{tarea1/ej1-caracteristicaestatica.eps}
    ...
    % \begin{figure}[H]
    % \centering
    % \includegraphics[width=0.85\textwidth]{tarea1/ej1-caracteristicaestaticazoom.eps}
    % \end{figure}
  \end{enumerate}
